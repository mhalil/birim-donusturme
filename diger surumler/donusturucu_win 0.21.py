...
def hesapla_uzn():
    ...
    cikti_str = tk.StringVar()
    if girdi_brm == "km" and cikti_brm == "m":
        sonuc = deger * 1000
        cikti_str.set(sonuc)
        entry_sonuc_uzn.delete(0, END)
        entry_sonuc_uzn.insert(0, cikti_str)
        print(cikti_str)


buton_donustur_uzn = ttk.Button(frame1, text = "Dönüştür", command=hesapla_uzn)
buton_donustur_uzn.place(x=300,y=140)
